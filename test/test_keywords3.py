...
class KeywordsTest3(unittest.TestCase): 
    def setUp(self):
        ...
        self.testFilePath = os.path.join(mySetting.configDirPath, 'test_keyword3_list.json')
    ...
    def test_getRegKeyword_대소문자_있으면(self):
        ...
        regKeyword = self.myKeywords.getRegKeyword("나의 제목 시즌01 My Title S01 720p.KOR.HDRip.H264.AAC-RTM", self.downloadRule)
    ...
    def test_getRegKeyword2(self):
        ...
        regKeyword = self.myKeywords.getRegKeyword("검은 김의 세계일2.E02.230618.1080p.WANNA", self.downloadRule)
    ...
    def test_getRegKeyword_exclude_keyword(self):
        ...
        regKeyword = self.myKeywords.getRegKeyword("My Title exclude1", self.downloadRule)
        self.assertIsNone((regKeyword))
        
        regKeyword = self.myKeywords.getRegKeyword("My Title exclude2", self.downloadRule)
        self.assertIsNone((regKeyword))
        
        regKeyword = self.myKeywords.getRegKeyword("My Title 720p x264", self.downloadRule)
        self.assertEqual((regKeyword['name']), "My Title")
    ...
    def test_getRegKeyword_exclude_keyword2(self):
        ...
        regKeyword = self.myKeywords.getRegKeyword("second title", self.downloadRule)
