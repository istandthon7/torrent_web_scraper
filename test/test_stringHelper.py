...
class TestStringHelper(unittest.TestCase):
    ...
    def test_IsContainAllWordsInBoardTitle(self):
        ...
        self.assertTrue(self.stringHelper.IsContainAllWordsInBoardTitle(keyword, boardTitle))

        keyword = 'apple banana grape'
        boardTitle = 'I like to eat apple and banana'
        self.assertFalse(self.stringHelper.IsContainAllWordsInBoardTitle(keyword, boardTitle))
